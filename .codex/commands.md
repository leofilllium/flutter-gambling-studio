...
| `/autocreate` | `.claude/skills/autocreate/SKILL.md` | Zero-to-playable конвейер |
...
| `/release-checklist` | `.claude/skills/release-checklist/SKILL.md` | Финальная проверка перед релизом |

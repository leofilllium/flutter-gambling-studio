...
| `/auto-idea --list` | Показать все 12 архетипов с описанием |
| `/auto-idea --archetype [A-L]` | Развернуть конкретный архетип |
...
/auto-idea --archetype H   # Неоновый Каскад — Plinko (Forge2D)
/auto-idea --list           # Показать все 12 с описанием
/auto-idea                  # Процедурная Уникальная Генерация
```
...
Отредактируй `.claude/skills/auto-idea/SKILL.md` — добавь архетип M–Z.

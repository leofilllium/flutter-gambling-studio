...
Generated raster art uses the concept's or mapped reference's chosen 2D or 2.5D finish. Match
its silhouettes, linework, materials, palette, shading, detail and light. Do not add modeled
volume, gradients, gloss or star glints to a 2D reference that does not have them.
...
Generic stock art, mismatched rendering languages and unrequested style substitutions remain out
of scope. Inspect relevant `examples-games/` through

...
В Codex PNG/image generation выполняется через встроенный **GPT Images 2.0**; фон простых ассетов вырезать локально при необходимости, background-изображения не трогать.

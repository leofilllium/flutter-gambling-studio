...
V1–V19 problems from `emulator-test` plus `.claude/docs/mobile-first-contract.md` and
...
| 1. Screenshots | At least 5 valid PNGs and 0 CRITICAL/HIGH V1–V19/mobile-phone/gameplay-contract defects | 2 (SKIPPED if there is no device) |

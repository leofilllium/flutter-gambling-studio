...
launcher label и листинга), цвет фона splash (из Design DNA → Background), категорию C1–C6
и compliance-профиль (для метаданных и возрастного рейтинга).
...
> **Compliance (ОБЯЗАТЕЛЬНО для модерации):** в `full_description.txt` и `age-rating.md`
...
4. Выпускать без disclaimer / age-gate / responsible-play / возрастного рейтинга (release-блокер).
   Ослабление допустимо только для C5 без покупок — и должно быть зафиксировано в концепте.

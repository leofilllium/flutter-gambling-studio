...
| Royal crown slot | `examples-games/shining-crown.jpeg` | C1 / A / M1 | Object; crown, jewel star, clover gem, ruby, supported multiplier medallions | No invented player or mascot; slides 1–2 show authentic reels at a three-quarter/3D angle, with reward objects across the foreground |
